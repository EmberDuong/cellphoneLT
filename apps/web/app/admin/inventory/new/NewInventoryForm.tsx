...
export default function NewInventoryForm({ 
  ...
  const [state, formAction, isPending] = useActionState(createInventoryAction, { error: null, details: {} as any });
    ...
    <>
      <header className="admin-topbar">
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <h1 className="admin-topbar-title">Nhập kho mới</h1>
        </div>
      </header>
        ...
        <div className="card" style={{ padding: "1.5rem", background: "var(--card-bg, #fff)", borderRadius: "8px", border: "1px solid var(--border-color, #eaeaea)" }}>
          <form action={formAction} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              ...
              <select name="productId" className="form-input" style={{ width: "100%" }} required>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              <div>
                ...
                <input type="text" name="imeiSerial" className="form-input" style={{ width: "100%" }} placeholder="Dành cho máy cũ / thiết bị có mã riêng" />
              ...
              <div>
                ...
                <input type="number" name="quantity" defaultValue={1} className="form-input" style={{ width: "100%" }} required min="1" />
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              <div>
                ...
                <select name="conditionGrade" className="form-input" style={{ width: "100%" }} defaultValue="new">
              ...
              <div>
                ...
                <select name="stockStatus" className="form-input" style={{ width: "100%" }} defaultValue="available">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              <div>
                ...
                <input type="text" name="warehouseLocation" className="form-input" style={{ width: "100%" }} placeholder="Vd: Kệ A1, Tầng 2" />
              </div>

              <div>
                <label style={{ display: "block", fontSize: "0.875rem", fontWeight: 500, marginBottom: "0.25rem" }}>Giá nhập (VNĐ)</label>
                <input type="number" name="costPrice" className="form-input" style={{ width: "100%" }} />
              </div>
            </div>

            <div>
              <label style={{ display: "block", fontSize: "0.875rem", fontWeight: 500, marginBottom: "0.25rem" }}>Ghi chú thêm</label>
              <textarea name="notes" className="form-input" style={{ width: "100%", minHeight: 80 }} placeholder="Mô tả thêm về tình trạng, nguồn gốc..."></textarea>
            </div>
